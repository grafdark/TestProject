...
<div class="container">
    ...
    <div class="contact-page main grid-wrap">
        ...
        <section class="grid col-three-quarters mq2-col-two-thirds mq3-col-full">
            <h2><spring:message code="message.edit.task"/></h2>

            <p class="warning">${message}</p>

                <form:form action="edit_task.html" id="contact_form" class="contact_form" modelAttribute="task"
                           method="post">
                    <input type="hidden" name="id" value="${taskForEdit.id}">
                    <input type="hidden" name="date" value="${taskForEdit.date}">
                    <ul>
                        <li>
                            <label><spring:message code="message.name.task"/></label>
                            <input type="text" name="name" value="${taskForEdit.name}" required="required"/>

                        </li>
                        <li>
                            <label><spring:message code="message.select.executor"/></label>
