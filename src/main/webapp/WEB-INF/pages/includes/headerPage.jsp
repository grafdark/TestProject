...
<header id="navtop">
    ...
    <nav class="fright">
        ...
        <ul>
            <li>
                <spring:message code="message.create" text="CREATE"/>
            </li>
            <li>
                <a href="create_executor_page.html"><spring:message code="message.executor" text="Executor"/></a>
            </li>
            <li>
                <a href="create_task_page.html"><spring:message code="message.task" text="Task"/></a>
            </li>
        </ul>
    </nav>
</header>
